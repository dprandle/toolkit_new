...
Map_Editor::Map_Editor(Context * context, void * window_id)
    : Urho_Editor(context, window_id),
      scene_(nullptr),
      cam_node_(nullptr),
      ...
      draw_debug_(false)
{
    ...
    SubscribeToEvent(E_SCENEUPDATE, URHO3D_HANDLER(Map_Editor, handle_scene_update));
    SubscribeToEvent(E_INPUT_TRIGGER, URHO3D_HANDLER(Map_Editor, handle_input_event));
    SubscribeToEvent(E_POSTRENDERUPDATE, URHO3D_HANDLER(Map_Editor, handle_post_render_update));
...
void Map_Editor::handle_post_render_update(StringHash event_type, VariantMap & event_data)
{
    if (draw_debug_)
    {
        if (scene_ != nullptr)
...
void Map_Editor::create_visuals()
{
...
void Map_Editor::setup_global_keys(Input_Context * ctxt)
{
...
void Map_Editor::handle_scene_update(StringHash /*event_type*/, VariantMap & event_data)
{}

void Map_Editor::handle_input_event(StringHash event_type, VariantMap & event_data)
{
